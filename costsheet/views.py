...
def generate_cost_sheet(request):
    ...
    try:
        ...
        for record in all_records:
            ...
            user_entries = {}  # Dictionary to store consolidated user entries
            for entry in entries:
                ...
                # Create a unique key for user and rate combination
                user_rate_key = f"{entry['user_name']}_{applicable_rate}"
                
                if user_rate_key in user_entries:
                    # If entry exists, add the hours
                    user_entries[user_rate_key]['hours'] += entry['hours']
                else:
                    # Create new entry if it doesn't exist
                    user_entries[user_rate_key] = {
            ...
            # Add all consolidated user entries to the assignment
            assignment_entries[assignment_key]['users'].extend(user_entries.values())

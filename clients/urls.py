...
urlpatterns = [
    ...
    path('edit_client_list', views.edit_client_list, name='Edit Client List'),
    path('closure_client_list', views.closure_client_list, name='Closure Client List'),
    path('edit_one_client/<slug:id>', views.edit_one_client, name='Edit One Client'),
    path('submit_edit_client', views.submit_edit_client, name='Submit Edit Client'),
    ...
    path('close_client', views.close_client, name='Close Client'),
    path('check_client_name', views.check_client_name, name='Check Client Name'),
]
